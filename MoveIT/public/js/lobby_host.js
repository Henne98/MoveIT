...
const socket = io();               // Socket.io Verbindung herstellen
const startBtn = document.getElementById('start-button');

// 1️⃣ Beim Klick auf „Spiel starten“ das Event zum Server schicken
startBtn.addEventListener('click', () => {
    const lobbyCode = localStorage.getItem('lobbyCode');   // oder aus der URL lesen
